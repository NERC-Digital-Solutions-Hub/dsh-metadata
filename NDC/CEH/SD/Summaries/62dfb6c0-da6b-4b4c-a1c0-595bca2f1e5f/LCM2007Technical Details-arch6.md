...
## Overview
- LCM2007 is provided in both vector and raster formats to support a range of users and needs across the UK.

## Vector data (most detailed)
- Each polygon represents a land cover parcel with attributes describing land cover and metadata describing how the information was derived (see dataset documentation).
- Scale: Minimum Mapable Unit for land cover parcels = 0.5 ha.
- Supply format: ESRI Shapefile.
- Coverage: UK.

## Raster data
- Five raster products are available.
...
- Scale: 25 m and 1 km pixel sizes.
- Supply format: GeoTiff.
- Coverage: UK.

## Further information
- See the document 'Land Cover Map 2007 Dataset Documentation' for details:
