...
- For full methodological details, refer to the Methods_overview document.

## Key Definitions
- Edge pixels: Pixels at the edge of floral unit clusters or in the center of small clusters where the pixel appears mixed with other features.
- Pure pixels: Pixels deeper in the centre of floral unit clusters, less likely to be mixed with other features.
- Merged categories: Regions of interest for different classification categories that are merged together into one or more groups rather than kept separate.
...
- July_3cm_classification3: All merged categories; removal of Centraurea nigra 'a5' signature within merged Centaurea nigra category; edge and pure values.
