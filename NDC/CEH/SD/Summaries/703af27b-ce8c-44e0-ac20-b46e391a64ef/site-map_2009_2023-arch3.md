# Thames river monitoring sites list
...
- Purpose and use:
  - Provides a codified inventory of monitoring locations across the Thames basin and nearby rivers for environmental health assessment.
  - Facilitates consistent data collection, cross-referencing, and governance across monitoring datasets.
  - Supports comprehensive policy scrutiny, data sharing, and informing future decisions by local authorities and environmental bodies.