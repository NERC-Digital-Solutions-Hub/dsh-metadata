...
The underlying data for this indicator is derived from the English Indices of Deprivation 2019 (IMD 2019), specifically utilizing the "Crime Domain" score, which combines multiple crime types (such as violence, burglary, theft, and criminal damage) to create an overall measure of crime-related deprivation.
