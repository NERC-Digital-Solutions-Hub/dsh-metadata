...
* **Central Estimate (50th Percentile):** Based on **UKCP09 probabilistic projections**, this represents the **median scenario**, where there is an equal probability that actual temperatures will be higher or lower than this value. This central estimate, specifically when tied to a medium emissions scenario, is explicitly identified as the **recommended starting point** for assessing future heat risks.
