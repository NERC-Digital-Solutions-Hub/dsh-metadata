### Summer extreme Relative Z-score maximum temperature moderate emissions 100 year return period 2020 median

#### Description

This **"All-Relative" Z-score** provides a standardized measure of the likely current severity of a 1% annual-chance daytime heat event in a world where global greenhouse gas emissions peak around 2040. Standardizing across all scenarios highlights neighbourhoods that are currently "relatively hot" during these exceptionally rare events compared to all database time periods and scenarios.
