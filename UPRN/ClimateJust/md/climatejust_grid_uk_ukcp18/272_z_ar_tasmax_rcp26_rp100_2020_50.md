### Summer extreme Relative Z-score maximum temperature low emissions 100 year return period 2020 median

#### Description

This **"All-Relative" Z-score** provides a standardized measure of the likely current severity of a 1% annual-chance daytime heat event in a world tracking towards low emissions. Standardizing across all scenarios highlights neighbourhoods that are currently "relatively hot" during these extreme events compared to the dataset mean across all time periods.
